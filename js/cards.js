...
function nextCard() { if (activeCardIdx < cardData.length - 1) { deselectEl(); activeCardIdx++; renderAll(); pushHash(); } }
function prevCard() { if (activeCardIdx > 0) { deselectEl(); activeCardIdx--; renderAll(); pushHash(); } }
